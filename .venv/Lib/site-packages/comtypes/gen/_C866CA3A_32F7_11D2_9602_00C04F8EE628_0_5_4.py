...
__all__ = [
    'DISPID_SBSFormat', 'DISPID_SpeechPhraseAlternate', 'SPAS_STOP',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPRulesItem',
    'ISpeechMemoryStream', 'SVSFDefault', 'ISpeechWaveFormatEx',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCEPropertyNumberChange', 'SPPHRASERULE',
    'SPSHT_Unknown', 'SAFTADPCM_22kHzMono',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRCEStartStream',
    'eLEXTYPE_PRIVATE19', 'DISPID_SAFGuid', 'DISPID_SRRAudioFormat',
    'SSFMCreateForWrite', 'ISpeechRecoContext',
    'SDA_Two_Trailing_Spaces', 'SVSFIsXML', 'SAFT22kHz16BitMono',
    'SDKLLocalMachine', 'DISPID_SRProfile', 'DISPID_SpeechFileStream',
    'SpeechTokenIdUserLexicon', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRAttributes', 'SVSFUnusedFlags',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_START_INPUT_STREAM',
    'SBOPause', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRRPhraseInfo', 'SREAllEvents', 'ISpShortcut',
    'DISPID_SRDisplayUI', 'DISPID_SOTDataKey', 'ISpXMLRecoResult',
    'DISPID_SRCEFalseRecognition', 'DISPID_SLPPhoneIds',
    'SAFT12kHz16BitMono', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_PHRASE_START', 'DISPID_SRGRecoContext', 'SVP_21', 'SVP_7',
    'SLODynamic', 'SVSFlagsAsync', 'DISPID_SRGDictationSetState',
    'SAFTADPCM_11kHzMono', 'ISpeechPhraseProperties',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPPFirstElement',
    'DISPID_SVRate', 'SPPROPERTYINFO', 'SAFT12kHz8BitMono',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRCEAdaptation',
    'DISPID_SPAsItem', 'SPEI_TTS_PRIVATE', 'SVEVoiceChange',
    'SAFTExtendedAudioFormat', 'DISPID_SRCEHypothesis',
    'DISPID_SRCESoundStart', 'DISPID_SRRTStreamTime',
    'SAFT16kHz16BitMono', 'DISPID_SRGCmdLoadFromFile',
    'SVSFVoiceMask', 'SDTProperty', 'SECFEmulateResult',
    'SpeechCategoryRecognizers', 'DISPID_SpeechObjectTokens',
    'DISPID_SPRsItem', 'SpNullPhoneConverter',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPEs_NewEnum',
    'SVSFNLPSpeakPunc', 'DISPID_SVSPhonemeId', 'SAFT16kHz8BitStereo',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPRsCount', 'SP_VISEME_18',
    'SpeechUserTraining', 'DISPID_SVVoice',
    'DISPID_SpeechPhraseReplacement',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_PRIVATE18', 'SpPhoneConverter', 'SREFalseRecognition',
    'SAFT11kHz8BitMono', 'SAFT16kHz16BitStereo',
    'DISPID_SRGDictationUnload', 'IStream', 'ISpObjectWithToken',
    'SPRECOGNIZERSTATUS', 'SRCS_Enabled', 'WAVEFORMATEX',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPRuleParent', 'SINone',
    'ISpeechVoice', 'eLEXTYPE_PRIVATE14', 'SAFTGSM610_44kHzMono',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRName',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpAudio',
    'SRSInactiveWithPurge', 'SWPUnknownWordUnpronounceable', 'SVP_17',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SVSLastStreamNumberQueued', 'eLEXTYPE_PRIVATE13',
    'SpSharedRecoContext', 'SpShortcut', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPPBRestorePhraseFromMemory', 'LONG_PTR',
    'SPEI_END_SR_STREAM', 'DISPID_SGRsFindRule', 'DISPID_SLPsItem',
    'DISPID_SGRSTPropertyId', 'SpeechDisplayAttributes',
    'ISpProperties', 'SPAS_CLOSED', 'SpCustomStream',
    'DISPID_SDKEnumValues', 'DISPID_SGRsAdd', 'SPEVENT',
    'DISPID_SRGetRecognizers', 'SFTSREngine',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPEDisplayText',
    'DISPID_SPEsCount', 'SPRS_ACTIVE', 'SPINTERFERENCE_TOOSLOW',
    'SpeechEngineConfidence', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCResume',
    'DISPID_SLWPronunciations', 'SRESoundEnd', 'DISPID_SOTCId',
    'DISPID_SWFEBlockAlign', 'DISPID_SPEAudioTimeOffset',
    'SGPronounciation', 'SVP_14', 'SPBO_AHEAD',
    'SpeechRecoProfileProperties', 'SAFT11kHz16BitStereo',
    'DISPID_SGRSTsItem', 'SRERequestUI', 'SRESoundStart',
    'DISPID_SRSAudioStatus',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTSetId',
    'DISPID_SRCEBookmark', 'DISPID_SRCBookmark',
    'DISPID_SpeechPhraseBuilder', 'Speech_Max_Pron_Length',
    'SpeechSpecialTransitionType', 'ISpRecoGrammar',
    'DISPID_SPIElements', 'SPRST_ACTIVE', 'SPPHRASE', 'SPBO_PAUSE',
    ...
    'SpPhraseInfoBuilder', 'ISpeechPhraseAlternates',
    'tagSPTEXTSELECTIONINFO', 'SpeechVisemeType',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVResume', 'SPSLMA', 'DISPID_SVDisplayUI',
    'eLEXTYPE_PRIVATE6', 'DISPID_SVIsUISupported', 'SPSHORTCUTTYPE',
    'SP_VISEME_21', 'SPPARTOFSPEECH', 'SPPS_RESERVED1',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRAudioInputStream',
    'DISPID_SDKDeleteKey', 'SPLEXICONTYPE', 'SPPS_Unknown',
    'SPSHT_OTHER', 'DISPID_SPPNumberOfElements',
    'SAFT44kHz8BitStereo', 'SPWT_DISPLAY',
    'SWPKnownWordPronounceable', 'SPWORD', 'IInternetSecurityMgrSite',
    'SPCT_SLEEP', 'DISPIDSPTSI_ActiveLength', 'SAFT16kHz8BitMono',
    'SpeechInterference', 'ISequentialStream', 'DISPID_SVPause',
    '_RemotableHandle', 'SGLexicalNoSpecialChars',
    'SDKLDefaultLocation', 'ISpeechAudioStatus',
    'SPINTERFERENCE_NONE', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SVSFPurgeBeforeSpeak', 'SPSHORTCUTPAIRLIST', 'SDTLexicalForm',
    'SPEVENTSOURCEINFO', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SLPLangId', 'ISpeechRecognizer',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPSERIALIZEDPHRASE',
    'SSSPTRelativeToEnd', 'DISPID_SPEsItem', 'SPVPRIORITY',
    'DISPID_SOTId', 'SpeechLexiconType', 'DISPID_SPACommit',
    'DISPID_SPRText', 'DISPID_SLGetPronunciations', 'DISPID_SLWsItem',
    'SpeechTokenKeyUI', 'SPCT_DICTATION', 'SVSFNLPMask',
    'SPLOADOPTIONS', 'SPWORDLIST', 'ISpeechLexiconPronunciations',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVVolume', 'SVEPrivate',
    'SpFileStream', 'SPEI_SR_PRIVATE', 'SPEI_REQUEST_UI',
    'ISpNotifyTranslator', 'SINoise',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SWFEFormatTag',
    'SPVPRI_ALERT', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVEventInterests', 'SVSFPersistXML', 'ISpPhoneConverter',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPAsCount', 'SPEI_VISEME',
    'SpeechGrammarState', 'eLEXTYPE_VENDORLEXICON',
    'SVEStartInputStream', 'DISPID_SRRecognizer', 'SPVOICESTATUS',
    'SPSSuppressWord', 'SVEEndInputStream',
    'DISPID_SpeechPhraseAlternates', 'SPEI_SOUND_START',
    'ISpRecoCategory', 'SPAO_RETAIN_AUDIO',
    'DISPID_SLGetGenerationChange', 'ISpRecognizer2',
    'SGDSActiveWithAutoPause', 'SP_VISEME_1', 'SPBOOKMARKOPTIONS',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_SOUND_END',
    'IEnumString', '_ISpeechRecoContextEvents', 'SPEI_MIN_TTS',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SGRsItem',
    'SGRSTTTextBuffer', 'DISPID_SpeechWaveFormatEx',
    'SpeechWordPronounceable', 'DISPID_SLPType',
    'SAFT44kHz16BitStereo', 'SP_VISEME_14', 'SRTReSent',
    'DISPID_SRCRetainedAudio', 'SPAO_NONE', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SAFSetWaveFormatEx', 'SSFMOpenReadWrite',
    'SpeechRunState', 'SPBO_NONE', 'SPEVENTENUM',
    'DISPID_SABufferInfo', 'SPFM_OPEN_READWRITE',
    'SAFT8kHz8BitStereo', 'ISpeechRecognizerStatus',
    'SPTEXTSELECTIONINFO', 'SVP_15', 'SREPhraseStart',
    'DISPID_SPEDisplayAttributes', 'SGRSTTDictation',
    'DISPID_SLAddPronunciation', 'ISpRecognizer3',
    'SPGRAMMARWORDTYPE', 'SGDSActiveUserDelimited',
    'DISPID_SMSADeviceId', 'SPSEMANTICFORMAT', 'SWTDeleted', 'SVP_18',
    'ISpeechRecoResult', 'DISPID_SDKGetlongValue',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPEAudioStreamOffset',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVGetAudioOutputs',
    'ISpeechXMLRecoResult', 'DISPID_SRCVoicePurgeEvent', 'SITooFast',
    ...
    'DISPID_SDKGetStringValue', 'SPCT_COMMAND',
    'DISPID_SAEventHandle', 'SAFTADPCM_8kHzMono', 'SPCONTEXTSTATE',
    'ISpeechPhraseRule', 'DISPID_SRRTimes',
    'DISPID_SpeechPhraseReplacements', 'SVF_Emphasis',
    'SPEI_VOICE_CHANGE', 'SVPAlert', 'STCInprocHandler',
    'DISPID_SVEViseme', 'SPFM_CREATE_ALWAYS', 'SPRS_INACTIVE',
    'SVP_2', 'SPSUnknown', 'SpeechEngineProperties',
    'SpeechMicTraining', 'DISPID_SPIRule', 'SPAUDIOSTATE',
    'SAFTGSM610_22kHzMono', 'SAFT12kHz16BitStereo', 'SPPS_Function',
    'DISPID_SpeechObjectTokenCategory', 'SECFIgnoreKanaType',
    'SPSNotOverriden', 'SAFT44kHz16BitMono',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRAddResource',
    'SpeechCategoryRecoProfiles', '__MIDL_IWinTypes_0009',
    'SVSFIsNotXML', 'DISPID_SLWLangId', 'DISPID_SPPConfidence',
    'ISpMMSysAudio', 'DISPID_SASState', 'SPINTERFERENCE',
    'SPEI_UNDEFINED', 'DISPID_SPEActualConfidence',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SVEVoiceChange',
    'SSFMCreate', 'SpMemoryStream', 'DISPID_SVEWord',
    'ISpeechDataKey', 'SAFT22kHz8BitStereo',
    'DISPID_SRCEPropertyStringChange', 'IEnumSpObjectTokens',
    'DISPID_SPIGrammarId', 'SpAudioFormat', 'eLEXTYPE_USER',
    'DISPID_SRCEAudioLevel', 'SREStreamStart', 'SPEI_TTS_BOOKMARK',
    'DISPID_SGRsCommit', 'SRSInactive', 'SpTextSelectionInformation',
    'SASPause', 'SPLO_STATIC', 'DISPID_SRGId', 'SLTUser',
    'DISPID_SFSClose', 'DISPID_SWFEExtraData', 'DISPID_SPPValue',
    'SP_VISEME_7', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechVoiceEvent', 'ISpeechVoiceStatus', 'SVP_13',
    'DISPID_SpeechDataKey', 'SpeechWordType', 'DISPID_SLWsCount',
    'SPEI_RECOGNITION', 'Speech_StreamPos_Asap',
    'DISPID_SOTCEnumerateTokens', 'SAFT24kHz8BitMono', 'SITooLoud',
    'SPCATEGORYTYPE', 'SPCT_SUB_DICTATION', 'SpeechTokenKeyFiles',
    'ISpeechGrammarRules', 'SASRun', 'ISpPhraseAlt',
    'SpeechStreamFileMode', 'DISPIDSPTSI_ActiveOffset',
    'SPSMF_SAPI_PROPERTIES', 'SpeechPropertyAdaptationOn',
    'Speech_StreamPos_RealTime', 'SpeechDictationTopicSpelling',
    'eLEXTYPE_PRIVATE10', 'SVP_12', 'SPEI_RESERVED1',
    'DISPID_SPCIdToPhone', 'SECFNoSpecialChars', 'SAFTText',
    'SPAR_Low', 'DISPID_SRRGetXMLResult', 'SREStateChange',
    'DISPID_SLPSymbolic', 'SPSEMANTICERRORINFO',
    'SPWORDPRONOUNCEABLE', 'SPEI_SENTENCE_BOUNDARY',
    'SVESentenceBoundary', 'SAFTCCITT_uLaw_8kHzStereo', 'SVPOver',
    'SSSPTRelativeToCurrentPosition', 'SPPS_NotOverriden',
    'SpeechTokenShellFolder', 'SASClosed', 'SPEI_MAX_SR', 'SRSActive',
    'SPSNoun', 'DISPID_SpeechGrammarRuleStateTransitions', 'SRARoot',
    'SpeechVoiceSpeakFlags', 'eLEXTYPE_RESERVED4', 'SPPHRASEPROPERTY',
    'SDTAlternates', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRsDynamic',
    'ISpeechObjectTokens', 'SAFT24kHz8BitStereo', 'SPSFunction',
    'DISPID_SPPEngineConfidence', 'SGDSActive', 'STCRemoteServer',
    'ISpStreamFormat', 'DISPID_SGRSTs_NewEnum', 'SVSFParseMask',
    'ISpRecoGrammar2', 'SWTAdded', 'SVP_3', 'SVEAudioLevel', 'SVP_20',
    'ISpeechPhraseReplacements', 'DISPID_SPAPhraseInfo',
    '_SPAUDIOSTATE', 'SPSHORTCUTPAIR', 'DISPID_SGRSTsCount',
    'ISpeechBaseStream', 'DISPID_SpeechCustomStream', 'SVP_5',
    'SGDisplay', 'DISPID_SOTIsUISupported',
    'DISPID_SRSetPropertyString', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRGCmdLoadFromResource', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPRuleId', 'STSF_CommonAppData', 'DISPID_SRRTTickCount',
    'ISpResourceManager', 'DISPID_SWFEChannels',
    'DISPID_SVEEnginePrivate', 'SP_VISEME_11', 'SAFTGSM610_11kHzMono',
    'SPPS_LMA', 'SGRSTTEpsilon', 'DISPID_SASNonBlockingIO',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPIStartTime',
    'SPAUDIOOPTIONS', 'ISpeechRecoGrammar',
    'DISPID_SRCRequestedUIType', 'SP_VISEME_10', 'SpeechDiscardType',
    'DISPID_SPCPhoneToId', 'DISPID_SVAudioOutput', 'SPAS_RUN',
    'SRATopLevel', 'DISPID_SRCPause', 'SGRSTTWord',
    'eWORDTYPE_DELETED', 'SAFT11kHz8BitStereo', 'DISPID_SpeechVoice',
    'SAFT12kHz8BitStereo', 'DISPID_SPEAudioSizeBytes',
    'SpInprocRecognizer', 'SLTApp', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPAUDIOSTATUS', 'DISPID_SVEBookmark', 'DISPID_SBSSeek',
    'SPRECORESULTTIMES', 'DISPID_SRState',
    'DISPID_SRGetPropertyString', 'DISPID_SASCurrentDevicePosition',
    'eLEXTYPE_PRIVATE11', 'DISPID_SWFEBitsPerSample',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFTNonStandardFormat',
    'eLEXTYPE_RESERVED10', 'DISPID_SRRAudio',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVESentenceBoundary',
    'SpeechBookmarkOptions', 'DISPID_SPIReplacements',
    'SPINTERFERENCE_NOISE', 'DISPID_SRRSpeakAudio',
    'DISPID_SPRuleFirstElement', 'DISPID_SGRSTPropertyName',
    'DISPID_SABIMinNotification', 'SP_VISEME_5', 'DISPID_SGRSTText',
    'DISPID_SVEStreamStart', 'DISPID_SPRules_NewEnum',
    'DISPID_SOTRemove', 'SPSTREAMFORMATTYPE', 'SpeechLoadOption',
    'SpeechGrammarTagDictation', 'SPEI_RESERVED5', 'DISPID_SGRsCount',
    'SAFT22kHz16BitStereo', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechPhraseInfoBuilder', 'DISPID_SABIEventBias',
    'DISPID_SVGetVoices', 'SpeechDataKeyLocation', 'ISpObjectToken',
    'SVSFIsFilename', 'SPGS_DISABLED', 'DISPID_SPPName',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpRecoContext2',
    'ISpeechRecoResultTimes', 'DISPID_SOTs_NewEnum',
    'STCInprocServer', 'SP_VISEME_12',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVWaitUntilDone',
    'DISPID_SRGCommit', 'SAFTCCITT_uLaw_8kHzMono', 'ISpRecoResult',
    'ISpeechCustomStream', 'DISPID_SpeechObjectToken',
    'eLEXTYPE_PRIVATE20', 'SAFT48kHz16BitStereo', 'SDTDisplayText',
    'DISPID_SVPriority', 'SVEPhoneme', 'SPVPRI_NORMAL',
    'SpeechCategoryAudioIn', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechRecoResult', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SLPsCount', 'DISPID_SMSALineId', 'SpeechAudioFormatType',
    'SpeechEmulationCompareFlags', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRs_NewEnum', 'SP_VISEME_17', 'SpeechGrammarTagWildcard',
    'DISPID_SDKSetStringValue', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVEAudioLevel', 'SP_VISEME_4', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPRFirstElement', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_PRIVATE8', 'SPRECOSTATE',
    'SPPS_SuppressWord', 'DISPID_SRGReset', 'SBONone',
    'SAFT24kHz16BitMono', 'SRAONone', 'DISPID_SVSLastBookmarkId',
    'SWPUnknownWordPronounceable', 'Speech_Default_Weight',
    'SpeechRuleAttributes', 'SPBO_TIME_UNITS', 'DISPID_SLWWord',
    'DISPID_SpeechMemoryStream', 'SDTAudio', 'SpUnCompressedLexicon',
    'DISPID_SVGetProfiles', 'SPEI_HYPOTHESIS', 'SDKLCurrentUser',
    'ISpeechGrammarRuleState', 'ISpVoice', 'DISPID_SPPChildren',
    'ISpObjectTokenCategory', 'SpeechAudioFormatGUIDWave',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpGrammarBuilder',
    'SDTReplacement', 'DISPID_SPRuleChildren', 'DISPID_SLWs_NewEnum',
    'SSTTTextBuffer', 'eLEXTYPE_RESERVED6', 'SPINTERFERENCE_TOOQUIET',
    'SpeechTokenContext', 'SPEI_ADAPTATION', 'DISPID_SAVolume',
    'DISPID_SMSSetData', 'DISPID_SpeechRecognizerStatus',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechRetainedAudioOptions', 'SVP_9',
    'SPBINARYGRAMMAR', 'DISPID_SRIsShared', 'STCAll',
    'DISPID_SPRuleName', 'SRAExport', 'SAFTGSM610_8kHzMono',
    'DISPID_SMSGetData', 'SAFT48kHz16BitMono', 'SPWORDTYPE',
    'DISPID_SpeechRecoContext', 'DISPID_SPELexicalForm', 'SVP_4',
    'SREBookmark', 'SAFTNoAssignedFormat', 'ISpeechPhraseInfo',
    'ISpeechLexiconWords', 'DISPID_SVSInputSentencePosition',
    'SPEI_INTERFERENCE', 'DISPID_SPIProperties', 'UINT_PTR',
    'SPRECOCONTEXTSTATUS', 'DISPID_SVSLastBookmark',
    'SREInterference', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SAFType', 'DISPID_SRCERequestUI', 'DISPID_SGRClear',
    'ISpeechMMSysAudio', 'SPEI_PHONEME',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFT44kHz8BitMono',
    'DISPID_SOTCDefault', 'SP_VISEME_15', 'ISpeechFileStream',
    'SPPS_Noun', 'SpeechTokenKeyAttributes', 'SDA_No_Trailing_Space',
    'DISPID_SRCEInterference', 'DISPID_SLPs_NewEnum', 'SpLexicon',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPCLangId',
    'ISpeechTextSelectionInformation', 'SVP_6', 'SSTTDictation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechRecoContextState',
    'ISpeechPhraseElement', 'SAFTADPCM_44kHzMono',
    'DISPID_SABIBufferSize', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRCRecognizer', 'SPSERIALIZEDRESULT', 'SVEViseme',
    'SP_VISEME_6', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SpeechBaseStream',
    'ISpeechObjectToken', 'SPWT_LEXICAL',
    'DISPID_SRCSetAdaptationData', 'SRSEIsSpeaking',
    'SAFT32kHz16BitMono', 'DISPID_SGRSTWeight',
    'DISPIDSPTSI_SelectionOffset', 'SpStreamFormatConverter',
    'DISPID_SVSpeakStream', 'SPEI_MIN_SR', 'SLOStatic',
    'SpeechCategoryAudioOut', 'ISpStream', 'SRTStandard',
    'SRERecoOtherContext', 'SpeechPartOfSpeech', 'SDTAll',
    'SAFT48kHz8BitMono', 'SRERecognition', 'SPPHRASEELEMENT',
    'SPWT_PRONUNCIATION', 'SPPS_Noncontent', 'SRTAutopause',
    'SPVPRI_OVER', 'SPGRAMMARSTATE', 'SREStreamEnd',
    'DISPID_SGRInitialState', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechVisemeFeature',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRGetFormat', 'ISpNotifySource', 'DISPID_SVSRunningState',
    'SP_VISEME_13', 'DISPID_SPEEngineConfidence',
    ...
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPAStartElementInResult',
    'ISpeechPhraseElements', 'SRTSMLTimeout', 'SPGS_ENABLED',
    'DISPID_SDKDeleteValue', 'SP_VISEME_20',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPPs_NewEnum',
    'ISpeechRecoResult2', 'DISPID_SGRSAddRuleTransition',
    'ISpRecoContext', 'ISpeechPhraseAlternate',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechLexiconWord',
    'SpeechFormatType', 'SPGS_EXCLUSIVE', 'SDTRule',
    'ISpeechLexiconPronunciation', 'DISPID_SDKSetLongValue',
    'SpInProcRecoContext', '_ISpeechVoiceEvents',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_APP', 'ISpEventSource',
    'SAFTADPCM_8kHzStereo', 'DISPID_SOTCSetId', 'SP_VISEME_9',
    'ISpRecognizer', 'DISPID_SPILanguageId', 'SPPS_RESERVED2',
    'DISPID_SOTMatchesAttributes', 'SpResourceManager',
    'ISpeechLexicon', 'SGSExclusive', 'DISPID_SVGetAudioInputs',
    'SPDATAKEYLOCATION', 'DISPID_SADefaultFormat',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVStatus',
    'SPRST_INACTIVE_WITH_PURGE', 'SPLO_DYNAMIC', 'SpeechAudioVolume',
    'SECFDefault', 'SPEI_MAX_TTS', 'SpeechRecognitionType',
    'SPDKL_CurrentUser', 'ISpeechPhraseProperty', 'DISPID_SRStatus',
    'DISPID_SVSVisemeId', 'SP_VISEME_0', 'SRAImport',
    'DISPID_SLPPartOfSpeech', 'SPEI_RESERVED3', 'SSTTWildcard',
    'DISPID_SLRemovePronunciation', 'SREPropertyNumChange',
    'eLEXTYPE_PRIVATE17', 'STSF_FlagCreate', 'DISPID_SRSClsidEngine',
    'DISPID_SPRNumberOfElements', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVSLastResult', 'SP_VISEME_8',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRRRecoContext',
    'ISpeechAudio', 'SVP_8', 'ISpeechAudioFormat',
    'DISPID_SDKCreateKey', 'SASStop', 'SAFTADPCM_44kHzStereo',
    'eLEXTYPE_PRIVATE7', 'SPWF_INPUT', 'SVPNormal', 'DISPIDSPRG',
    'DISPID_SRCEEndStream', 'DISPID_SRRTLength', 'SPSHT_EMAIL',
    'eLEXTYPE_RESERVED9', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechLexiconWords', 'SPSInterjection',
    'SAFT48kHz8BitStereo', 'SVEWordBoundary',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'DISPID_SGRId',
    'DISPID_SPRs_NewEnum', 'SPPS_RESERVED4', 'SVF_None',
    'DISPID_SGRSTType', 'SpeechRegistryUserRoot', 'SRSEDone',
    'SpeechCategoryAppLexicons', 'SVSFParseSapi', 'SPPS_Modifier',
    'SITooSlow', 'SPRULE', 'DISPID_SRSCurrentStreamPosition',
    'SPFM_NUM_MODES', 'DISPID_SpeechGrammarRule',
    'SPXMLRESULTOPTIONS', 'SPPS_Verb', 'SPDKL_CurrentConfig',
    'DISPID_SWFESamplesPerSec', 'SDKLCurrentConfig',
    'DISPID_SPPParent', 'SpeechPropertyResponseSpeed',
    'DISPID_SRGRules', 'SPEI_RESERVED2', 'DISPID_SOTCategory',
    'SRADynamic', 'DISPID_SOTGetDescription', 'SREPrivate',
    'ISpeechObjectTokenCategory', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechPhraseRules', 'SpeechAllElements',
    'DISPID_SCSBaseStream', 'DISPID_SVEPhoneme',
    'DISPID_SRCCmdMaxAlternates', 'SpSharedRecognizer',
    'DISPID_SASCurrentSeekPosition', 'ISpDataKey',
    'DISPID_SOTGetStorageFileName', 'DISPID_SAStatus',
    'eLEXTYPE_RESERVED7', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPCS_ENABLED', 'SpeechGrammarWordType', 'SpeechVoicePriority',
    'eLEXTYPE_PRIVATE1', 'DISPID_SLGenerationId',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFT8kHz16BitMono', 'SVP_19',
    'DISPID_SGRAddState', 'SAFT32kHz8BitStereo',
    'ISpStreamFormatConverter', 'SECLowConfidence',
    'DISPID_SMSAMMHandle', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRGSetTextSelection', 'SECFIgnoreCase', 'STSF_AppData',
    'SITooQuiet', 'DISPID_SOTGetAttribute', 'DISPID_SLGetWords',
    'DISPIDSPTSI', 'SpMMAudioOut', 'SGDSInactive',
    'SPPS_Interjection', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRCESoundEnd', 'SPXRO_Alternates_SML',
    'DISPID_SOTCGetDataKey', 'SpeechRuleState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPARecoResult', 'ISpeechLexiconWord',
    'SPEI_WORD_BOUNDARY', 'SPRST_INACTIVE', 'SPSVerb',
    'DISPID_SpeechPhraseElement', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SBSRead', 'SpeechAudioState', 'DISPID_SASFreeBufferSpace',
    'SECHighConfidence', 'DISPID_SpeechAudioFormat', 'SP_VISEME_2',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechCategoryPhoneConverters',
    'SpWaveFormatEx', 'ISpeechPhraseRules', 'SVP_11',
    'Speech_Max_Word_Length', 'SPVISEMES',
    'DISPID_SpeechGrammarRules', 'SPAR_Medium', 'SREAdaptation',
    'DISPID_SGRSTransitions', 'SGLexical',
    'DISPID_SPRuleNumberOfElements', 'SVP_1', 'SpCompressedLexicon',
    'ISpLexicon', 'DISPID_SRGSetWordSequenceData',
    'ISpeechPhraseReplacement', 'SAFT8kHz8BitMono',
    'DISPID_SpeechPhraseInfo', 'SPEI_SR_BOOKMARK',
    'DISPID_SPEPronunciation', 'SPAR_Unknown', 'SECFIgnoreWidth',
    'SAFT22kHz8BitMono', 'DISPID_SpeechXMLRecoResult',
    'SRADefaultToActive', 'SPFM_CREATE', 'DISPID_SVEStreamEnd',
    'SPSMF_UPS', 'DISPID_SOTCreateInstance', 'SGRSTTWildcard',
    'SREPropertyStringChange', 'DISPID_SPRuleConfidence',
    'SPPHRASEREPLACEMENT', 'SFTInput', 'DISPID_SRGetPropertyNumber',
    'SRAInterpreter', 'DISPID_SpeechLexiconProns', 'SpMMAudioIn',
    'SpeechPropertyComplexResponseSpeed',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVSInputWordPosition',
    'SpObjectTokenCategory', 'IInternetSecurityManager',
    'DISPID_SOTDisplayUI', 'SpMMAudioEnum', 'SAFT32kHz8BitMono',
    'DISPID_SRCERecognition', 'SRSActiveAlways', 'SPAS_PAUSE',
    'SPXRO_SML', 'ISpPhoneticAlphabetConverter',
    'SPEI_END_INPUT_STREAM', 'ISpeechGrammarRule',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SFSOpen',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTDefault', 'SPFM_OPEN_READONLY',
    'DISPID_SGRSRule', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRGIsPronounceable', 'SPSModifier',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_16',
    'SRTExtendableParse', 'SpeechAudioProperties',
    'eLEXTYPE_RESERVED8', 'SPAUDIOBUFFERINFO',
    'DISPID_SPERequiredConfidence', 'DISPID_SDKEnumKeys',
    'SPCS_DISABLED', 'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPPsItem',
    'SpeechVoiceEvents', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechLexicon',
    'SPEI_START_SR_STREAM', 'DISPID_SRSSupportedLanguages',
    'SPFILEMODE', 'DISPID_SPPId', 'SpeechRecognizerState',
    'SAFTTrueSpeech_8kHz1BitMono', 'SRCS_Disabled',
    'SAFT24kHz16BitStereo', 'DISPID_SVSCurrentStreamNumber',
    'SPWAVEFORMATTYPE', 'SpeechTokenValueCLSID', 'SPDKL_LocalMachine',
    'DISPID_SRCVoice', 'DISPID_SPEAudioSizeTime', 'DISPID_SLWType',
    'DISPID_SGRsCommitAndSave', 'SAFTADPCM_22kHzStereo',
    'DISPID_SOTsItem', 'DISPID_SpeechAudio',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRCState',
    ...
    'DISPID_SRCEPhraseStart', 'DISPID_SVAudioOutputStream',
    'SpNotifyTranslator', 'SPPS_RESERVED3',
    'DISPID_SVSInputWordLength', 'ISpEventSink', 'ISpPhrase',
    'SpeechRecoEvents', 'SSFMOpenForRead', 'SREHypothesis',
    'DISPID_SPRDisplayAttributes', 'SpStream', 'SpVoice',
    'SDA_One_Trailing_Space', 'SP_VISEME_3',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRGCmdSetRuleIdState',
    'SPAR_High', 'SVEBookmark', 'eLEXTYPE_PRIVATE16',
    'DISPID_SVSpeak', 'DISPID_SPISaveToMemory', 'SINoSignal',
    'SAFTADPCM_11kHzStereo', 'DISPID_SBSWrite',
    'DISPID_SPIAudioSizeBytes', 'SPWORDPRONUNCIATION',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRRAlternates',
    'DISPID_SPIGetText', 'DISPID_SpeechRecognizer',
    'DISPID_SRCreateRecoContext', 'DISPID_SPAs_NewEnum', 'SVP_0',
    'DISPID_SPIAudioSizeTime', 'SVP_10', 'SRAORetainAudio',
    'SP_VISEME_19', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SASetState', 'DISPID_SDKSetBinaryValue',
    'SPCT_SUB_COMMAND', 'SpObjectToken',
    'DISPID_SpeechGrammarRuleState', 'SSSPTRelativeToStart',
    'DISPID_SpeechRecoResult2', 'SVSFParseSsml', 'SGSDisabled',
    'DISPID_SPIEnginePrivateData',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SVSkip',
    'DISPID_SGRSTRule', 'DISPID_SAFGetWaveFormatEx',
    'SAFT32kHz16BitStereo', 'SPDKL_DefaultLocation',
    'SpeechAddRemoveWord', 'DISPID_SREmulateRecognition',
    'DISPID_SpeechAudioStatus', 'ISpeechRecoResultDispatch',
    'SDTPronunciation', 'DISPID_SGRSTNextState', 'SPWF_SRENGINE',
    'DISPID_SRIsUISupported', 'STCLocalServer', 'tagSTATSTG',
    'eLEXTYPE_PRIVATE3', 'SREAudioLevel', 'DISPID_SOTsCount',
    ...
    'DISPID_SPRulesCount', 'SRTEmulated', 'SVEAllEvents',
    'SGSEnabled', 'SPSHT_NotOverriden', 'SPEI_RESERVED6',
    'SGRSTTRule', 'ISpeechPhoneConverter'
]

_check_version('1.2.1', 1700051274.921600)
